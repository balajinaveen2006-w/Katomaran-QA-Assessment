...
- Defect ID: BUG-001
- Module: Login
- Issue: Application allows users to log in with an invalid email format (Assessment Scenario)
...
```
Task1_Tichi_TestCases.xlsx
Task2_Defect_Report.docx
README.md
```
